...
<body>
	...
	<section>
		...
		<div>
			...
			%>
			<a
				href="<%=request.getContextPath()%>/UserList/2.wsl_board.jsp?currentPage=<%=currentPage - 1%>">이전</a>
			<%
			}
			if (currentPage < lastPage) {
			%>
			<a
				href="<%=request.getContextPath()%>/UserList/2.wsl_board.jsp?currentPage=<%=currentPage + 1%>">다음</a>
			<%
			}
			%>
		</div>
