...
ArrayList<usedcarVo> searchCarList = new ArrayList<usedcarVo>();
ArrayList<usedcarVo> bucket1 = new ArrayList<usedcarVo>();
ArrayList<usedcarVo> bucket2 = new ArrayList<usedcarVo>();
ArrayList<usedcarVo> bucket3 = new ArrayList<usedcarVo>();
ArrayList<usedcarVo> bucket4 = new ArrayList<usedcarVo>();
