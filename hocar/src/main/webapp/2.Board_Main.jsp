			...
			<ul class="slidelist">
				<li>
					<a> 
						...
						<img src="https://media.discordapp.net/attachments/879272150723354647/909470061750779914/unknown.png?width=960&height=409" width=1800px height=500px>
						<label for="slide05" class="right"></label><!--for태그로 사진순환 넘버링  -->
					</a>
				</li>
				<li>
					<a> 
						<label for="slide04" class="left"></label>
						<img src="https://media.discordapp.net/attachments/879272150723354647/909467728555946024/banner202131042AK6Q.jpg?width=960&height=264" width=1800px height=500px>
				...
				<li>
					<a> 
						...
						<img src="https://media.discordapp.net/attachments/879272150723354647/909450558912475156/unknown.png?width=960&height=381" width=1800px height=500px>
...
<footer>
	<form ACTION="2.Board_Buy.jsp">
		<button class="button">구매</button>
	</form>

	<form ACTION="2.Board_Sell_Page.jsp">
		<button class="button">판매</button>
	</form>
